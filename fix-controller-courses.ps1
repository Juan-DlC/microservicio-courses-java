# Fix CourseControllerTest.java - quita @WebMvcTest, usa MockMvcBuilders.standaloneSetup
...
'@ -NoNewline
git add "src\test\java\co\edu\uniremington\mscourses\controller\CourseControllerTest.java"
